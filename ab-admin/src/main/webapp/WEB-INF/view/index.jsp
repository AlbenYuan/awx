            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/image/default-avatar.png" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Sender Name
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/image/default-avatar.png" class="user-image" alt="User Image">
                            <span class="hidden-xs">Alexander Pierce</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/image/default-avatar.png" class="img-circle" alt="User Image">
                                <p>
                                    Alexander Pierce
                                    <br/>Web Developer
